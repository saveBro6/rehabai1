...
INSERT INTO "public"."doctors" ("full_name", "specialty", "avatar_url", "bio", "experience_years", "rating", "consultation_fee", "available_online", "created_at", "id") VALUES
	('Dr. Test', 'Physical Therapy', NULL, 'Experienced therapist for test purposes', 5, 5.0, 500000.00, true, '2026-05-27 09:59:02.837345+00', '10000000-0000-4000-8000-000000000003'),
	('BS. Lê Minh Khoa', 'Phục hồi chức năng', 'doctors/le-minh-khoa.jpg', 'Chuyên điều trị phục hồi sau đột quỵ và chấn thương.', 12, 4.9, 350000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1'),
	('ThS. Nguyễn Hà My', 'Vật lý trị liệu', 'doctors/nguyen-ha-my.jpg', 'Tập trung vào bài tập cá nhân hóa và phục hồi khả năng di chuyển.', 9, 4.8, 280000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa2'),
	('BS. Phạm Đức Trí', 'Thần kinh', 'doctors/pham-duc-tri.jpg', 'Tư vấn theo dõi biến chứng thần kinh sau đột quỵ.', 15, 4.9, 450000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa3'),
	('BS. Võ Anh Thư', 'Cơ xương khớp', 'doctors/vo-anh-thu.jpg', 'Hỗ trợ phục hồi sau chấn thương và đau mỏi vận động.', 10, 4.7, 320000.00, false, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa4'),
	('CNDD. Hoàng Ngọc Lan', 'Dinh dưỡng phục hồi', 'doctors/hoang-ngoc-lan.jpg', 'Tư vấn dinh dưỡng giúp người bệnh có nền tảng phục hồi tốt hơn.', 8, 4.8, 250000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa5') ON CONFLICT DO NOTHING;
