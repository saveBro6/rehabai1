...
INSERT INTO "public"."doctors" ("full_name", "specialty", "avatar_url", "bio", "experience_years", "rating", "consultation_fee", "available_online", "created_at", "id") VALUES
	('Dr. Test', 'Physical Therapy', 'images/doctors/dr-test.jpg', 'Experienced therapist for test purposes', 5, 5.0, 500000.00, true, '2026-05-27 09:59:02.837345+00', '10000000-0000-4000-8000-000000000003'),
	('BS. Lê Minh Khoa', 'Phục hồi chức năng', 'images/doctors/le-minh-khoa.jpg', 'Chuyên điều trị phục hồi sau đột quỵ và chấn thương.', 12, 4.9, 350000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa1'),
	('ThS. Nguyễn Hà My', 'Vật lý trị liệu', 'images/doctors/nguyen-ha-my.jpg', 'Tập trung vào bài tập cá nhân hóa và phục hồi khả năng di chuyển.', 9, 4.8, 280000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa2'),
	('BS. Phạm Đức Trí', 'Thần kinh', 'images/doctors/pham-duc-tri.jpg', 'Tư vấn theo dõi biến chứng thần kinh sau đột quỵ.', 15, 4.9, 450000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa3'),
	('BS. Võ Anh Thư', 'Cơ xương khớp', 'images/doctors/vo-anh-thu.jpg', 'Hỗ trợ phục hồi sau chấn thương và đau mỏi vận động.', 10, 4.7, 320000.00, false, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa4'),
	('CNDD. Hoàng Ngọc Lan', 'Dinh dưỡng phục hồi', 'images/doctors/hoang-ngoc-lan.jpg', 'Tư vấn dinh dưỡng giúp người bệnh có nền tảng phục hồi tốt hơn.', 8, 4.8, 250000.00, true, '2026-05-27 09:59:02.881857+00', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaa5') ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."products" ("id", "name", "description", "category", "price", "image_url", "stock_quantity", "is_recommended", "created_at") VALUES
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb1', 'Bộ bóng mềm tập nắm tay', 'Dụng cụ tập lực nắm và vận động bàn tay cho người cần phục hồi sau đột quỵ.', 'Dụng cụ tập tay', 180000.00, 'images/products/hand-grip.jpg', 40, true, '2026-05-27 09:59:02.881857+00'),
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb2', 'Dây kéo kháng lực RehabAI', 'Dây kháng lực nhiều mức độ cho bài tập tay, vai và chân.', 'Dây kháng lực', 220000.00, 'images/products/resistance-band.jpg', 35, true, '2026-05-27 09:59:02.881857+00'),
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb3', 'Khung tập đi gấp gọn', 'Hỗ trợ người bệnh tập đi an toàn trong quá trình tập luyện có giám sát.', 'Khung tập đi', 1250000.00, 'images/products/walker.jpg', 12, true, '2026-05-27 09:59:02.881857+00'),
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb4', 'Bóng tập phục hồi 55cm', 'Bóng tập giúp cải thiện thăng bằng, sức mạnh thân mình và độ linh hoạt.', 'Bóng tập phục hồi', 360000.00, 'images/products/therapy-ball.jpg', 24, false, '2026-05-27 09:59:02.881857+00'),
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb5', 'Bàn đạp tập chân tại nhà', 'Dụng cụ tập chân nhỏ gọn cho người cần cải thiện tầm vận động.', 'Dụng cụ tập chân', 690000.00, 'images/products/pedal-trainer.jpg', 18, true, '2026-05-27 09:59:02.881857+00'),
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb6', 'Ghế tắm hỗ trợ an toàn', 'Ghế chống trượt hỗ trợ sinh hoạt hằng ngày cho người cao tuổi và người yếu vận động.', 'Ghế hỗ trợ', 780000.00, 'images/products/shower-chair.jpg', 14, false, '2026-05-27 09:59:02.881857+00'),
	('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb7', 'Máy đo huyết áp điện tử', 'Thiết bị theo dõi sức khỏe tại nhà, phù hợp với người cần quan sát chỉ số định kỳ.', 'Thiết bị theo dõi sức khỏe', 950000.00, 'images/products/blood-pressure-monitor.jpg', 30, true, '2026-05-27 09:59:02.881857+00') ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."exercises" ("id", "title", "slug", "description", "category", "difficulty", "body_region", "duration_minutes", "repetitions", "sets", "instructions", "precautions", "image_url", "video_url", "is_active", "created_at") VALUES
	...
	('f1111111-1111-4111-8111-111111111112', 'Nắm mở bàn tay', 'nam-mo-ban-tay', 'Cải thiện khả năng chủ động của ngón tay và bàn tay.', 'Chi trên', 'Cơ bản', 'Bàn tay', 6, 12, 3, '{"Đặt cẳng tay lên bàn.","Nắm bàn tay chậm rãi.","Mở từng ngón tay hết mức có thể."}', '{"Dừng lại nếu có co thắt hoặc đau tăng nhanh."}', 'images/exercises/hand-open-close.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111113', 'Duỗi cổ tay', 'duoi-co-tay', 'Kéo giãn nhẹ nhóm cơ gấp cổ tay, phù hợp với người bị cứng cơ.', 'Linh hoạt', 'Cơ bản', 'Bàn tay', 5, 8, 2, '{"Đưa cánh tay ra trước.","Dùng tay còn lại kéo nhẹ bàn tay về phía sau.","Giữ 10 giây và thở đều."}', '{"Không giật mạnh cổ tay.","Nếu tê lan xuống ngón tay, dừng tập."}', 'images/exercises/wrist-stretch.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111114', 'Nâng chân khi ngồi', 'nang-chan-khi-ngoi', 'Tăng sức mạnh đùi trước và khả năng kiểm soát chân khi ngồi.', 'Chi dưới', 'Cơ bản', 'Chân', 8, 10, 2, '{"Ngồi trên ghế, hai chân chạm sàn.","Duỗi một chân về phía trước đến khi gối gần thẳng.","Hạ chân chậm và đổi bên."}', '{"Giữ lưng thẳng, không ngả người ra sau."}', 'images/exercises/seated-leg-raise.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111115', 'Tập đứng lên ngồi xuống', 'tap-dung-len-ngoi-xuong', 'Hỗ trợ khả năng độc lập trong sinh hoạt hằng ngày.', 'Sức mạnh', 'Trung cấp', 'Chân', 10, 8, 3, '{"Ngồi sát mép ghế chắc chắn.","Đặt hai chân rộng bằng vai.","Đẩy người đứng lên rồi ngồi xuống chậm rãi."}', '{"Cần có tay vịn hoặc người hỗ trợ nếu thăng bằng chưa tốt."}', 'images/exercises/sit-to-stand.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111116', 'Tập giữ thăng bằng', 'tap-giu-thang-bang', 'Rèn luyện thăng bằng tĩnh để giảm nguy cơ té ngã.', 'Tập thăng bằng', 'Cơ bản', 'Toàn thân', 7, 5, 2, '{"Đứng gần mặt bàn hoặc tay vịn.","Giữ hai chân rộng bằng hông.","Giữ tư thế 20-30 giây và thở đều."}', '{"Luôn tập gần điểm bám chắc chắn.","Dừng ngay nếu chóng mặt."}', 'images/exercises/balance-training.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111117', 'Bước ngang có hỗ trợ', 'buoc-ngang-co-ho-tro', 'Cải thiện khả năng di chuyển ngang và kiểm soát hông.', 'Vận động', 'Trung cấp', 'Hông', 10, 10, 2, '{"Đứng cạnh tay vịn.","Bước một chân sang ngang.","Kéo chân còn lại về gần và lặp lại."}', '{"Không tập khi sàn trơn.","Cần người giám sát nếu từng té ngã gần đây."}', 'images/exercises/supported-side-step.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111118', 'Kéo giãn vai', 'keo-gian-vai', 'Giảm căng cứng vùng vai và cải thiện tầm vận động.', 'Linh hoạt', 'Cơ bản', 'Vai', 6, 8, 2, '{"Đưa tay ngang ngực.","Dùng tay còn lại kéo nhẹ cánh tay về phía thân mình.","Giữ 10 giây mỗi lần."}', '{"Không ép vai nếu có đau nhói."}', 'images/exercises/shoulder-stretch.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
	('f1111111-1111-4111-8111-111111111119', 'Gập duỗi gối', 'gap-duoi-goi', 'Hỗ trợ tầm vận động khớp gối sau chấn thương hoặc phẫu thuật.', 'Phục hồi chấn thương', 'Cơ bản', 'Gối', 8, 10, 2, '{"Ngồi hoặc nằm với chân duỗi thoải mái.","Gập gối chậm rãi trong mức không đau.","Duỗi chân về vị trí ban đầu."}', '{"Tuân thủ giới hạn vận động nếu mới phẫu thuật."}', 'images/exercises/knee-flexion-extension.jpg', NULL, true, '2026-05-27 09:59:02.696807+00'),
