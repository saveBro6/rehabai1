            ...
            <div className="mt-5 rounded-lg border border-emerald-200 bg-emerald-50 p-4">
              ...
              {isWalletLoading ? (
                ...
                <div className="mt-4 border-t border-emerald-200 pt-4">
                  <Link
                    href="/patient/wallet"
                    className="inline-flex text-sm font-bold text-emerald-700 underline decoration-emerald-300 underline-offset-4 hover:text-emerald-800"
                  >
                    Nạp thêm {formatCurrency(missingWalletAmount)} vào ví bằng QR payOS
                  </Link>
                </div>
              ) : (
